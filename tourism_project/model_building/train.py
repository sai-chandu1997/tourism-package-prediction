...
Xtrain_path = "hf://datasets/<---repo id---->/tourism-package-analysis/Xtrain.csv"
Xtest_path = "hf://datasets/<---repo id---->/tourism-package-analysis/Xtest.csv"
ytrain_path = "hf://datasets/<---repo id---->/tourism-package-analysis/ytrain.csv"
ytest_path = "hf://datasets/<---repo id---->/tourism-package-analysis/ytest.csv"
...
with mlflow.start_run():
    ...
    repo_id = "<---repo id---->/tourism_package_model"
    repo_type = "model"
    ...
    try:
        ...
        print(f"Space '{repo_id}' created.")   z
